...
export default function CartItem ({item,index,setTotal,total,productCount,setProductCount}: CartItemProps){
  ...
  const removeFromCart = () => {
    ...
    axios.delete(`https://localhost:7075/api/Order/DeleteFromCart/${item.cartId}/${userEmail}`)
  ...
  return (
    ...
    <div className="col-2 text-center"><input type="checkbox"  onChange={handleChange}/></div>
